Function.prototype.mycall = function(){
    ...
    let newargs = orgargs.splice(1);// new arguments from idx=1 . we saved all the passing arguments 
...
obj.fun1.mycall(o2, "Maithili", "devansh", "bunny");// in this we  get our o2 obj.
obj.fun1("adarsh", "Devansh");// In this out we recived Normal This 
